...
insert into customer_type(`name`) values ('Diamond'), ('Platinum'), ('Gold'), ('Silver'), ('Member');
insert into customer(customer_type_id, `name`, date_of_birth, gender, id_card, phone_number, email, address, `status`)
values (1, 'Nguyễn Thị Hào', '1970-11-07', 0, 643431213, 0945423362, 'thihao07@gmail.com', '23 Nguyễn Hoàng, Đà Nẵng', 0),
...
insert into facility (`name`, area, cost, max_people, rent_type_id, facility_type_id, standard_room, description_other_convenience, pool_area, number_of_floors, `status`)
values ('Villa Beach Front', 25000, 10000000, 10, 3, 1, 'vip', 'Có hồ bơi', 500, 4, 0),
       ('House Princess 01', 14000, 5000000, 7, 2, 2, 'vip', 'Có thêm bếp nướng', 0, 3, 0),
       ('Room Twin 01', 5000,  1000000, 2, 4, 3, 'normal', 'Có tivi', 0, 0, 0),
       ('Villa No Beach Front', 22000, 9000000, 8, 3, 1, 'normal', 'Có hồ bơi', 300, 3, 0),
       ('House Princess 02', 10000, 4000000, 5, 3, 2, 'normal', 'Có thêm bếp nướng', 0, 2, 0),
	   ('Room Twin 02', 3000,  900000, 2, 4, 3, 'normal', 'Có tivi', 0, 0, 0);
...
insert into employee (`name`, date_of_birth, id_card, salary, phone_number, email, address, position_id, education_degree_id, division_id, `status`)
values ('Nguyễn Văn An', '1970-11-07', '456231786', 10000000, 0901234121, 'annguyen@gmail.com', '295 Nguyễn Tất Thành, Đà Nẵng', 1, 3, 1, 0),
...
('Khúc Nguyễn An Nghi', '2000-11-08', '964542311', 7000000, 0978653213, 'annghi20@gmail.com', '294 Nguyễn Tất Thành, Đà Nẵng', 2, 2, 3, 0),
...
insert into contract(start_date, end_date, deposit, customer_id, facility_id) 
